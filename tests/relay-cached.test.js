...
describe('Testing Switcher Relay', () => {
    ...
    test('RELAY_CACHED_SUITE - Should return success when validating relay using GET method', async () => {
        // mock
    ...
    test('RELAY_CACHED_SUITE - Should return failure when validating relay using GET method', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'get');
    ...
    test('RELAY_CACHED_SUITE - Should return success when validating relay using POST method', async () => {
        // mock
    ...
    test('RELAY_CACHED_SUITE - Should return success when notifying relay using GET method', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'get');
    ...
    test('RELAY_CACHED_SUITE - Should return success when notifying relay using POST method', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'post');
    ...
    test('RELAY_CACHED_SUITE - Should return success when validating relay using GET method - no input', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'get');
    ...
    test('RELAY_CACHED_SUITE - Should return success when validating relay using POST method - no input', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'post');
    ...
    test('RELAY_CACHED_SUITE - Should NOT return success when validating relay using GET method - Service exception', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'get');
    ...
    test('RELAY_CACHED_SUITE - Should NOT return success when validating relay using POST method - Service exception', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'post');
        axiosStub.throwsException();
...
describe('Testing Switcher Relay Validation', () => {
    ...
    test('RELAY_CACHED_SUITE - Should return Relay could not be reached - Relay HTTPS required', async () => {
        // given
        // HTTPS not required
        process.env.RELAY_BYPASS_HTTPS = true;
...
describe('Testing Switcher Relay Verification', () => {
    ...
    test('RELAY_CACHED_SUITE - Should return Relay could not be reached - Not verified', async () => {
        // given
    ...
    test('RELAY_CACHED_SUITE - Should return success when validating verified relay', async () => {
        // mock
        axiosStub = sinon.stub(axios, 'get');
