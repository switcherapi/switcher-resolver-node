...
describe('Processing strategy: NETWORK', () => {
    ...
    test('UNIT_STRATEGY_SUITE - Should return TRUE when input range EXIST', () => {
        const result = processOperation(
            StrategiesType.NETWORK, OperationsType.EXIST, '10.0.0.3', fixture_values1);
        expect(result).toBe(true);
    });

    test('UNIT_STRATEGY_SUITE - Should return FALSE when input range DOES NOT EXIST', () => {
        const result = processOperation(
            StrategiesType.NETWORK, OperationsType.EXIST, '10.0.0.4', fixture_values1);
        expect(result).toBe(false);
    });

    test('UNIT_STRATEGY_SUITE - Should return TRUE when input NOT_EXIST', () => {
        const result = processOperation(
            StrategiesType.NETWORK, OperationsType.NOT_EXIST, '10.0.0.4', fixture_values1);
        expect(result).toBe(true);
    });

    test('UNIT_STRATEGY_SUITE - Should return TRUE when input IP EXIST', () => {
        const result = processOperation(
            StrategiesType.NETWORK, OperationsType.EXIST, '192.168.56.58', fixture_values3);
        expect(result).toBe(true);
    });

    test('UNIT_STRATEGY_SUITE - Should return TRUE when input IP DOES NOT EXIST', () => {
        const result = processOperation(
            StrategiesType.NETWORK, OperationsType.NOT_EXIST, '192.168.56.50', fixture_values3);
        expect(result).toBe(true);
    });

    test('UNIT_STRATEGY_SUITE - Should return TRUE when input range EXIST for multiple ranges', () => {
        const result = processOperation(
            StrategiesType.NETWORK, OperationsType.EXIST, '192.168.0.3', fixture_values2);
        expect(result).toBe(true);
    });

    test('UNIT_STRATEGY_SUITE - Should return FALSE when input range DOES NOT EXIST for multiple ranges', () => {
        const result = processOperation(
...
describe('Processing strategy: REGEX', () => {
    ...
    test('UNIT_STRATEGY_SUITE - Should fail for reDoS attempt', () => {
        const result = processOperation(
